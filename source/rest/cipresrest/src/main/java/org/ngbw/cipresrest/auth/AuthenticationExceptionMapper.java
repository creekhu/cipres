    ...
    public Response toResponse(AuthenticationException e) 
	{
        ...
        if (e.getRealm() != null) 
		{
            return Response.
                    ...
                    entity(new ErrorData("Authentication Error: " + e.toString(), "Authentication Error", ErrorData.AUTHENTICATION)).
                    build();
        } else 
		{
            return Response.
                    status(Status.UNAUTHORIZED).
                    type("application/xml").
                    entity(new ErrorData("Authorization Error: " + e.toString(), "Authentication Error", ErrorData.AUTHENTICATION)).
                    build();
        }
    }
