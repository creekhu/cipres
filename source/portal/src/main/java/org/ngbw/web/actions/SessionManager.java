	...
	*/
	...
	private boolean sendPasswordResetEmail(String email, String username, String code) {
		if (username == null || username.equals("") ||
			...
			String subject = "CIPRES Science Gateway Password Reset Confirmation";
			HttpServletRequest request = ServletActionContext.getRequest();
			String body = "A request was recently received to reset the password for your " +
				"registered account (" + username + ") on the CIPRES Science Gateway.  " +
				...
				"this link, you authorize CIPRES to reset your password to \"" + DEFAULT_PASSWORD +
