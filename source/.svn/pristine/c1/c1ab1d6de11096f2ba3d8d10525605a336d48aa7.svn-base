...
public class Upload extends HttpServlet 
{
	...
	public void init() throws ServletException
	{
		...
		try
		{
			...
			doGet = composer.datastore.getExtensions().contains("get");
		}
		...
		throws IOException, ServletException 
	{
		...
		try
		{
			...
			{
				new GetHandler(composer, request, response).go();
			}
			else
			{
	...
	*/
		...
		throws Exception
	{
		...
		// OPTIONS and GET don't require tus-resumable version header, everything else does
