...
var uploadList = document.querySelector("#list");
...
input.addEventListener("change", function (e) {
  ...
  var options = {
    ...
    onSuccess: function () {
	  ...
	  */
	  var uf = document.createElement("li");
	  uf.appendChild(document.createTextNode(upload.file.name + " (" + upload.file.size + " bytes)"));
      uploadList.appendChild(uf);
    }
  };
