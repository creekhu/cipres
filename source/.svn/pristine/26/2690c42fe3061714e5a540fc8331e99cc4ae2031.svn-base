...
public class AuthenticationInterceptor extends AbstractInterceptor
{
	...
	/**
	 * Updated by Mona to add displaying of error message stored in session
	 */
	...
	public String intercept(ActionInvocation invocation) throws Exception 
	{
		...
		if ( action.getSessionAttribute ( action.SESSION_ERROR_MESSAGE ) != null )
		{
			action.reportUserError ( ( String ) action.getSessionAttribute (
				action.SESSION_ERROR_MESSAGE ) );
			action.clearSessionAttribute ( action.SESSION_ERROR_MESSAGE );
		}
		else
