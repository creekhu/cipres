...
public class Workbench {
	...
	*/
	...
	/*
	public String submitTask(Task task) throws Exception, DisabledResourceException
	{
	...
	*/
	...
	public ValidationResult registerNewUser(User user) throws IOException, SQLException {
		...
		{
			result.addError("A user with this email: " + user.getEmail() + 
				" already exists with role = " + user.getRole());
			return result;
		}
		user.save();
		return result;
