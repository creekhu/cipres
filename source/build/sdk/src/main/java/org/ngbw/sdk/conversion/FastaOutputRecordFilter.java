 ...
 *
 */
public class FastaOutputRecordFilter implements RecordFilter {

	private static Log log = LogFactory.getLog(FastaOutputRecordFilter.class);
	private BufferedReader br;
	private DataFormat dataFormat;
	private static final Pattern startPattern = Pattern.compile("^# .*$");
	private static final Pattern lastBlockPattern = Pattern.compile("^(\\d+ residues in \\d+ query\\s+sequences\\s.*)$");
	private boolean inRecord = false;
	private String firstLine;
	private String infoBlock;
	private String nextRecord; 
	
	public FastaOutputRecordFilter() {
	}
