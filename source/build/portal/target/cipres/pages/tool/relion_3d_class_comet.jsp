...
<h2>Relion 3D classification: Perform 3D classification of single particles with 3D model using Relion (<a href="#REFERENCE">S. H. W. Scheres</a>)</h2>
<s:form action="relion_3d_class_comet" theme="simple">
...
<font color="red" size="3">*</font>
<s:select name="angular_sampling_" list="#{ '30':'30' , '15':'15' , '7.5':'7.5' , '3.7':'3.7' , '1.8':'1.8' , '0.9':'0.9' , '0.5':'0.5' , '0.2':'0.2' , '0.1':'0.1' }" onchange="resolveParameters()"/>
<br/>
<br/>
...
{
var element = document.forms['relion_3d_class_comet'].elements[parameter];
if (element == null)
{
return null;
}
...
{
var str = '';
var element = document.forms['relion_3d_class_comet'].elements;
...
input.value = str;
document.forms['relion_3d_class_comet'].appendChild(input);
}
</script>